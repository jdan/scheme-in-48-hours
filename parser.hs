...
-- extract func and args from a list expression
eval (List (Atom func : args)) = apply func $ map eval args

apply :: String -> [LispVal] -> LispVal
-- lookup function in a list of primitives
-- if it isn't found, return #f
-- if it is found, apply it to args
